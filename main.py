...
def user_input_features():
    inputs = {
        'LoanAmount': st.number_input('Enter Loan Amount', value=0),
        'CreditScore': st.number_input('Enter Credit Score', value=0),
        'MonthsEmployed': st.number_input('Enter Months Employed', value=0),
        'NumCreditLines': st.number_input('Enter Number of Credit Lines', value=0),
        'InterestRate': st.number_input('Enter Interest Rate', value=0),
        'LoanTerm': st.number_input('Enter Loan Term', value=0),
...
check_loan = st.button("Predict Loan Default")
